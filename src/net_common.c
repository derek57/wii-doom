...
#ifdef DEBUG_NET
    printf("NET_Conn_ParseDisconnect\n");
#endif
...
{
#ifdef DEBUG_NET
    printf("NET_Conn_ParseDisconnectACK\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_Conn_ParseReliableACK\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_Conn_ReliablePacket\n");
#endif
...
dboolean NET_ValidGameSettings(GameMode_t mode, GameMission_t mission,
                              net_gamesettings_t *settings)
{
#ifdef DEBUG_NET
    printf("NET_ValidGameSettings\n");
#endif
