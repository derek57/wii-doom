...
//    if (!SDLNet_UDP_Send((void*)udpsocket, -1, &sdl_packet))
    {
...
#ifdef NET_DEBUG
    printf("NET_SDL_RecvPacket\n");
#endif

    result = SDLNet_UDP_Recv(udpsocket, recvpacket);
//    result = SDLNet_UDP_Recv((void*)udpsocket, recvpacket);
