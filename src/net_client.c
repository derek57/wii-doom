...
extern void D_ReceiveTic(ticcmd_t *ticcmds, dboolean *playeringame);
...
dboolean net_waiting_for_launch = false;
                                    ...
                                    ticcmd_t *ticcmds)
{
...
#ifdef DEBUG_NET
    printf("NET_CL_ExpandFullTiccmd\n");
#endif
    ...
    if (seq > TICRATE)
    {
        fixed_t adjustment = (cmd->latency * FRACUNIT) - average_latency;
...
#ifdef DEBUG_NET
    printf("NET_CL_ParseWaitingData\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_CL_SendResendRequest\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_CL_ParseResendRequest\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_CL_ParseConsoleMessage\n");
#endif
...
// connect to a server
dboolean NET_CL_Connect(net_addr_t *addr, net_connect_data_t *data)
{
    int start_time;
    int last_send_time;

#ifdef DEBUG_NET
    printf("NET_CL_Connect\n");
#endif
...
dboolean NET_CL_GetSettings(net_gamesettings_t *_settings)
{
#ifdef DEBUG_NET
    printf("NET_CL_GetSettings\n");
#endif
