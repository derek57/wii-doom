...
#ifdef DEBUG_NET
    printf("BuildMasterStatusWindow\n");
#endif
...
{
    dboolean correct_wad/*, correct_deh*/;
    dboolean same_freedoom;
    txt_window_t *window;
    txt_window_action_t *cont_button;

#ifdef DEBUG_NET
    printf("CheckSHA1Sums\n");
#endif
