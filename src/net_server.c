...
// 20 minutes
#define MASTER_REFRESH_PERIOD 20 * 60

// How often to re-resolve the address of the master server?
// 8 hours
#define MASTER_RESOLVE_PERIOD 8 * 60 * 60
...
static dboolean server_initialized = false;


static void NET_SV_DisconnectClient(net_client_t *client)
{
#ifdef DEBUG_NET
    printf("NET_SV_DisconnectClient\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_SV_SendConsoleMessage\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_SV_BroadcastMessage\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_SV_LatestAcknowledged\n");
#endif
...
static dboolean AllNodesReady(void)
{
    unsigned int i;

#ifdef DEBUG_NET
    printf("AllNodesReady\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_SV_SendResendRequest\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_SV_ParseGameDataACK\n");
#endif
...
#ifdef DEBUG_NET
    printf("NET_SV_ParseResendRequest\n");
#endif
