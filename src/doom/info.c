...
state_t states[NUMSTATES] =
{
  //  sprite     frame                           tics               action             nextstate             state
    ...
    { SPR_BSKL,  0,                               10,               A_Look,            S_BSKUL_STND       }, // S_BSKUL_STND
    { SPR_BSKL,  1,                                5,               A_Chase,           S_BSKUL_RUN2       }, // S_BSKUL_RUN1
    { SPR_BSKL,  2,                                5,               A_Chase,           S_BSKUL_RUN3       }, // S_BSKUL_RUN2
    { SPR_BSKL,  3,                                5,               A_Chase,           S_BSKUL_RUN4       }, // S_BSKUL_RUN3
    { SPR_BSKL,  0,                                5,               A_Chase,           S_BSKUL_RUN1       }, // S_BSKUL_RUN4
    { SPR_BSKL,  4,                                4,               A_FaceTarget,      S_BSKUL_ATK2       }, // S_BSKUL_ATK1
    { SPR_BSKL,  5,                                5,               A_BetaSkullAttack, S_BSKUL_ATK3       }, // S_BSKUL_ATK2
    { SPR_BSKL,  5,                                4,               NULL,              S_BSKUL_RUN1       }, // S_BSKUL_ATK3
    { SPR_BSKL,  6,                                4,               NULL,              S_BSKUL_PAIN2      }, // S_BSKUL_PAIN1
    { SPR_BSKL,  7,                                2,               A_Pain,            S_BSKUL_RUN1       }, // S_BSKUL_PAIN2
    { SPR_BSKL,  8,                                4,               NULL,              S_BSKUL_RUN1       }, // S_BSKUL_PAIN3
    { SPR_BSKL,  9,                                5,               NULL,              S_BSKUL_DIE2       }, // S_BSKUL_DIE1
    { SPR_BSKL, 10,                                5,               NULL,              S_BSKUL_DIE3       }, // S_BSKUL_DIE2
    { SPR_BSKL, 11,                                5,               NULL,              S_BSKUL_DIE4       }, // S_BSKUL_DIE3
    { SPR_BSKL, 12,                                5,               NULL,              S_BSKUL_DIE5       }, // S_BSKUL_DIE4
    { SPR_BSKL, 13,                                5,               A_Scream,          S_BSKUL_DIE6       }, // S_BSKUL_DIE5
    { SPR_BSKL, 14,                                5,               NULL,              S_BSKUL_DIE7       }, // S_BSKUL_DIE6
    { SPR_BSKL, 15,                                5,               A_Fall,            S_BSKUL_DIE8       }, // S_BSKUL_DIE7
    { SPR_BSKL, 16,                                5,               A_Stop,            S_BSKUL_DIE8       }, // S_BSKUL_DIE8
    ...
    { SPR_FLSH,  2,                               -1,               NULL,              S_NULL             }, // S_FLESH_02
    { SPR_FLSH,  3,                               -1,               NULL,              S_NULL             }, // S_FLESH_03
    { SPR_FLSH,  4,                               -1,               NULL,              S_NULL             }, // S_FLESH_04
    { SPR_FLSH,  5,                               -1,               NULL,              S_NULL             }, // S_FLESH_05
    { SPR_FLSH,  6,                               -1,               NULL,              S_NULL             }, // S_FLESH_06
    { SPR_FLSH,  7,                               -1,               NULL,              S_NULL             }, // S_FLESH_07
    { SPR_FLSH,  8,                               -1,               NULL,              S_NULL             }, // S_FLESH_08
    { SPR_FLSH,  9,                               -1,               NULL,              S_NULL             }, // S_FLESH_09
    { SPR_FLSH, 10,                               -1,               NULL,              S_NULL             }, // S_FLESH_10
    { SPR_FLSH, 11,                               -1,               NULL,              S_NULL             }, // S_FLESH_11
    { SPR_FLSH, 12,                               -1,               NULL,              S_NULL             }, // S_FLESH_12
    { SPR_FLSH, 13,                               -1,               NULL,              S_NULL             }, // S_FLESH_13
    { SPR_FLSH, 14,                               -1,               NULL,              S_NULL             }, // S_FLESH_14
    { SPR_FLSH, 15,                               -1,               NULL,              S_NULL             }, // S_FLESH_15
    { SPR_FLSH, 16,                               -1,               NULL,              S_NULL             }, // S_FLESH_16
    { SPR_FLSH, 17,                               -1,               NULL,              S_NULL             }, // S_FLESH_17
    { SPR_FLSH, 18,                               -1,               NULL,              S_NULL             }, // S_FLESH_18
    { SPR_FLSH, 19,                               -1,               NULL,              S_NULL             }, // S_FLESH_19

    { SPR_SPRY,  0,                                3,               NULL,              S_SPRAY_01         }, // S_SPRAY_00
    { SPR_SPRY,  1,                                3,               NULL,              S_SPRAY_02         }, // S_SPRAY_01
    { SPR_SPRY,  2,                                3,               NULL,              S_SPRAY_03         }, // S_SPRAY_02
    { SPR_SPRY,  3,                                3,               NULL,              S_SPRAY_04         }, // S_SPRAY_03
    { SPR_SPRY,  4,                                3,               NULL,              S_SPRAY_05         }, // S_SPRAY_04
    ...
    { SPR_LVAS,  2 | FF_FULLBRIGHT,                5,               NULL,              S_LAVASPLASH4      }, // S_LAVASPLASH3
    { SPR_LVAS,  3 | FF_FULLBRIGHT,                5,               NULL,              S_LAVASPLASH5      }, // S_LAVASPLASH4
    { SPR_LVAS,  4 | FF_FULLBRIGHT,                5,               NULL,              S_LAVASPLASH6      }, // S_LAVASPLASH5
    { SPR_LVAS,  5 | FF_FULLBRIGHT,                5,               NULL,              S_NULL             }, // S_LAVASPLASH6
    { SPR_LVAS,  6 | FF_FULLBRIGHT,                5,               NULL,              S_LAVASMOKE2       }, // S_LAVASMOKE1
    { SPR_LVAS,  7 | FF_FULLBRIGHT,                5,               NULL,              S_LAVASMOKE3       }, // S_LAVASMOKE2
    { SPR_LVAS,  8 | FF_FULLBRIGHT,                5,               NULL,              S_LAVASMOKE4       }, // S_LAVASMOKE3
    ...
    { SPR_BPL3,  0 | FF_FULLBRIGHT,                6,               NULL,              S_BETAHEADCANDLES2 }, // S_BETAHEADCANDLES
    { SPR_BPL3,  1 | FF_FULLBRIGHT,                6,               NULL,              S_BETAHEADCANDLES  }, // S_BETAHEADCANDLES2

    { SPR_BPL5,  0,                               -1,               NULL,              S_NULL             }, // S_BETAGIBS

    { SPR_BBSK,  0,                               10,               NULL,              S_BETABSKULL2      }, // S_BETABSKULL
    { SPR_BBSK,  1 | FF_FULLBRIGHT,               10,               NULL,              S_BETABSKULL       }, // S_BETABSKULL2

    { SPR_BRSK,  0,                               10,               NULL,              S_BETARSKULL2      }, // S_BETARSKULL
    { SPR_BRSK,  1 | FF_FULLBRIGHT,               10,               NULL,              S_BETARSKULL       }, // S_BETARSKULL2

    { SPR_BYSK,  0,                               10,               NULL,              S_BETAYSKULL2      }, // S_BETAYSKULL
    { SPR_BYSK,  1 | FF_FULLBRIGHT,               10,               NULL,              S_BETAYSKULL       }, // S_BETAYSKULL2

    { SPR_BSHL,  0,                               -1,               NULL,              S_NULL             }, // S_BETASHELL

    { SPR_BCLL,  0,                               -1,               NULL,              S_NULL             }, // S_BETACELL

    { SPR_BBOX,  0,                               -1,               NULL,              S_NULL             }, // S_BETASBOX

    { SPR_BBXP,  0 | FF_FULLBRIGHT,                5,               NULL,              S_BETABEXP2        }, // S_BETABEXP
    { SPR_BBXP,  1 | FF_FULLBRIGHT,                5,               A_Scream,          S_BETABEXP3        }, // S_BETABEXP2
    { SPR_BBXP,  2 | FF_FULLBRIGHT,                5,               NULL,              S_BETABEXP4        }, // S_BETABEXP3
    { SPR_BBXP,  3 | FF_FULLBRIGHT,               10,               A_Explode,         S_BETABEXP5        }, // S_BETABEXP4
    { SPR_BBXP,  4 | FF_FULLBRIGHT,               10,               NULL,              S_NULL             }, // S_BETABEXP5

    { SPR_BPNS,  0 | FF_FULLBRIGHT,                6,               NULL,              S_BETAPINS2        }, // S_BETAPINS
    { SPR_BPNS,  1 | FF_FULLBRIGHT,                6,               NULL,              S_BETAPINS3        }, // S_BETAPINS2
    { SPR_BPNS,  2 | FF_FULLBRIGHT,                6,               NULL,              S_BETAPINS4        }, // S_BETAPINS3
    { SPR_BPNS,  3 | FF_FULLBRIGHT,                6,               NULL,              S_BETAPINS         }, // S_BETAPINS4

    { SPR_BPNV,  0 | FF_FULLBRIGHT,                6,               NULL,              S_BETAPINV2        }, // S_BETAPINV
    { SPR_BPNV,  1 | FF_FULLBRIGHT,                6,               NULL,              S_BETAPINV3        }, // S_BETAPINV2
    { SPR_BPNV,  2 | FF_FULLBRIGHT,                6,               NULL,              S_BETAPINV4        }, // S_BETAPINV3
    { SPR_BPNV,  3 | FF_FULLBRIGHT,                6,               NULL,              S_BETAPINV         }, // S_BETAPINV4

    { SPR_BBSS,  0,                               10,               A_Look,            S_BETABOSS_STND2   }, // S_BETABOSS_STND
    { SPR_BBSS,  1,                               10,               A_Look,            S_BETABOSS_STND    }, // S_BETABOSS_STND2
    { SPR_BBSS,  0,                                3,               A_Chase,           S_BETABOSS_RUN2    }, // S_BETABOSS_RUN1
    { SPR_BBSS,  0,                                3,               A_Chase,           S_BETABOSS_RUN3    }, // S_BETABOSS_RUN2
    { SPR_BBSS,  1,                                3,               A_Chase,           S_BETABOSS_RUN4    }, // S_BETABOSS_RUN3
    { SPR_BBSS,  1,                                3,               A_Chase,           S_BETABOSS_RUN5    }, // S_BETABOSS_RUN4
    { SPR_BBSS,  2,                                3,               A_Chase,           S_BETABOSS_RUN6    }, // S_BETABOSS_RUN5
    { SPR_BBSS,  2,                                3,               A_Chase,           S_BETABOSS_RUN7    }, // S_BETABOSS_RUN6
    { SPR_BBSS,  3,                                3,               A_Chase,           S_BETABOSS_RUN8    }, // S_BETABOSS_RUN7
    { SPR_BBSS,  3,                                3,               A_Chase,           S_BETABOSS_RUN1    }, // S_BETABOSS_RUN8
    { SPR_BBSS,  4,                                8,               A_FaceTarget,      S_BETABOSS_ATK2    }, // S_BETABOSS_ATK1
    { SPR_BBSS,  5,                                8,               A_FaceTarget,      S_BETABOSS_ATK3    }, // S_BETABOSS_ATK2
    { SPR_BBSS,  6,                                8,               A_BruisAttack,     S_BETABOSS_RUN1    }, // S_BETABOSS_ATK3
    { SPR_BBSS,  7,                                2,               NULL,              S_BETABOSS_PAIN2   }, // S_BETABOSS_PAIN
    { SPR_BBSS,  7,                                2,               A_Pain,            S_BETABOSS_RUN1    }, // S_BETABOSS_PAIN2
    { SPR_BBSS,  8,                                8,               NULL,              S_BETABOSS_DIE2    }, // S_BETABOSS_DIE1
    { SPR_BBSS,  9,                                8,               A_Scream,          S_BETABOSS_DIE3    }, // S_BETABOSS_DIE2
    { SPR_BBSS, 10,                                8,               NULL,              S_BETABOSS_DIE4    }, // S_BETABOSS_DIE3
    { SPR_BBSS, 11,                                8,               A_Fall,            S_BETABOSS_DIE5    }, // S_BETABOSS_DIE4
    { SPR_BBSS, 12,                               -1,               A_BossDeath,       S_NULL             }, // S_BETABOSS_DIE5
    { SPR_BBSS, 14,                                8,               NULL,              S_BETABOSS_RAISE2  }, // S_BETABOSS_RAISE1
    { SPR_BBSS, 13,                                8,               NULL,              S_BETABOSS_RAISE3  }, // S_BETABOSS_RAISE2
    { SPR_BBSS, 12,                                8,               NULL,              S_BETABOSS_RAISE4  }, // S_BETABOSS_RAISE3
    { SPR_BBSS, 11,                                8,               NULL,              S_BETABOSS_RAISE5  }, // S_BETABOSS_RAISE4
    { SPR_BBSS, 10,                                8,               NULL,              S_BETABOSS_RAISE6  }, // S_BETABOSS_RAISE5
    { SPR_BBSS,  9,                                8,               NULL,              S_BETABOSS_RAISE7  }, // S_BETABOSS_RAISE6
    { SPR_BBSS,  8,                                8,               NULL,              S_BETABOSS_RUN1    }, // S_BETABOSS_RAISE7

    { SPR_BCL1,  0,                               -1,               NULL,              S_NULL             }, // S_BETATALLGRNCOL

    { SPR_BELC,  0,                               -1,               NULL,              S_NULL             }, // S_BETATECHPILLAR

    { SPR_BPL4,  0,                               -1,               NULL,              S_NULL             }, // S_BETAHEADONASTICK

    { SPR_BPL7,  0,                               -1,               NULL,              S_NULL             }, // S_BETADEADSTICK

    { SPR_BPL6,  0,                                6,               NULL,              S_BETALIVESTICK2   }, // S_BETALIVESTICK
    { SPR_BPL6,  1,                                8,               NULL,              S_BETALIVESTICK    }, // S_BETALIVESTICK2

    { SPR_BSMT,  0,                               -1,               NULL,              S_NULL             }, // S_BETASTALAGTITE

    { SPR_BHED,  0,                               10,               A_Look,            S_BETAHEAD_STND    }, // S_BETAHEAD_STND
    { SPR_BHED,  0,                                3,               A_Chase,           S_BETAHEAD_RUN1    }, // S_BETAHEAD_RUN1
    { SPR_BHED,  1,                                5,               A_FaceTarget,      S_BETAHEAD_ATK2    }, // S_BETAHEAD_ATK1
    { SPR_BHED,  2,                                5,               A_FaceTarget,      S_BETAHEAD_ATK3    }, // S_BETAHEAD_ATK2
    { SPR_BHED,  3 | FF_FULLBRIGHT,                5,               A_HeadAttack,      S_BETAHEAD_RUN1    }, // S_BETAHEAD_ATK3
    { SPR_BHED,  4,                                3,               NULL,              S_BETAHEAD_PAIN2   }, // S_BETAHEAD_PAIN
    { SPR_BHED,  4,                                3,               A_Pain,            S_BETAHEAD_PAIN3   }, // S_BETAHEAD_PAIN2
    { SPR_BHED,  5,                                6,               NULL,              S_BETAHEAD_RUN1    }, // S_BETAHEAD_PAIN3
    { SPR_BHED,  6,                                8,               NULL,              S_BETAHEAD_DIE2    }, // S_BETAHEAD_DIE1
    { SPR_BHED,  7,                                8,               A_Scream,          S_BETAHEAD_DIE3    }, // S_BETAHEAD_DIE2
    { SPR_BHED,  8,                                8,               NULL,              S_BETAHEAD_DIE4    }, // S_BETAHEAD_DIE3
    { SPR_BHED,  9,                                8,               NULL,              S_BETAHEAD_DIE5    }, // S_BETAHEAD_DIE4
    { SPR_BHED, 10,                                8,               A_Fall,            S_BETAHEAD_DIE6    }, // S_BETAHEAD_DIE5
    { SPR_BHED, 11,                               -1,               NULL,              S_NULL             }, // S_BETAHEAD_DIE6
    { SPR_BHED, 11,                                8,               NULL,              S_BETAHEAD_RAISE2  }, // S_BETAHEAD_RAISE1
    { SPR_BHED, 10,                                8,               NULL,              S_BETAHEAD_RAISE3  }, // S_BETAHEAD_RAISE2
    { SPR_BHED,  9,                                8,               NULL,              S_BETAHEAD_RAISE4  }, // S_BETAHEAD_RAISE3
    { SPR_BHED,  8,                                8,               NULL,              S_BETAHEAD_RAISE5  }, // S_BETAHEAD_RAISE4
    { SPR_BHED,  7,                                8,               NULL,              S_BETAHEAD_RAISE6  }, // S_BETAHEAD_RAISE5
    { SPR_BHED,  6,                                8,               NULL,              S_BETAHEAD_RUN1    }, // S_BETAHEAD_RAISE6

    { SPR_BPSS,  0,                               10,               A_Look,            S_BETAPOSS_STND2   }, // S_BETAPOSS_STND
    { SPR_BPSS,  1,                               10,               A_Look,            S_BETAPOSS_STND    }, // S_BETAPOSS_STND2
    { SPR_BPSS,  0,                                4,               A_Chase,           S_BETAPOSS_RUN2    }, // S_BETAPOSS_RUN1
    { SPR_BPSS,  0,                                4,               A_Chase,           S_BETAPOSS_RUN3    }, // S_BETAPOSS_RUN2
    { SPR_BPSS,  1,                                4,               A_Chase,           S_BETAPOSS_RUN4    }, // S_BETAPOSS_RUN3
    { SPR_BPSS,  1,                                4,               A_Chase,           S_BETAPOSS_RUN5    }, // S_BETAPOSS_RUN4
    { SPR_BPSS,  2,                                4,               A_Chase,           S_BETAPOSS_RUN6    }, // S_BETAPOSS_RUN5
    { SPR_BPSS,  2,                                4,               A_Chase,           S_BETAPOSS_RUN7    }, // S_BETAPOSS_RUN6
    { SPR_BPSS,  3,                                4,               A_Chase,           S_BETAPOSS_RUN8    }, // S_BETAPOSS_RUN7
    { SPR_BPSS,  3,                                4,               A_Chase,           S_BETAPOSS_RUN1    }, // S_BETAPOSS_RUN8
    { SPR_BPSS,  4,                               10,               A_FaceTarget,      S_BETAPOSS_ATK2    }, // S_BETAPOSS_ATK1
    { SPR_BPSS,  5,                                8,               A_PosAttack,       S_BETAPOSS_ATK3    }, // S_BETAPOSS_ATK2
    { SPR_BPSS,  4,                                8,               NULL,              S_BETAPOSS_RUN1    }, // S_BETAPOSS_ATK3
    { SPR_BPSS,  6,                                3,               NULL,              S_BETAPOSS_PAIN2   }, // S_BETAPOSS_PAIN
    { SPR_BPSS,  6,                                3,               A_Pain,            S_BETAPOSS_RUN1    }, // S_BETAPOSS_PAIN2
    { SPR_BPSS,  7,                                5,               NULL,              S_BETAPOSS_DIE2    }, // S_BETAPOSS_DIE1
    { SPR_BPSS,  8,                                5,               A_Scream,          S_BETAPOSS_DIE3    }, // S_BETAPOSS_DIE2
    { SPR_BPSS,  9,                                5,               A_Fall,            S_BETAPOSS_DIE4    }, // S_BETAPOSS_DIE3
    { SPR_BPSS, 10,                                5,               NULL,              S_BETAPOSS_DIE5    }, // S_BETAPOSS_DIE4
    { SPR_BPSS, 11,                               -1,               NULL,              S_NULL             }, // S_BETAPOSS_DIE5
    { SPR_BPSS, 10,                                5,               NULL,              S_BETAPOSS_RAISE2  }, // S_BETAPOSS_RAISE1
    { SPR_BPSS,  9,                                5,               NULL,              S_BETAPOSS_RAISE3  }, // S_BETAPOSS_RAISE2
    { SPR_BPSS,  8,                                5,               NULL,              S_BETAPOSS_RAISE4  }, // S_BETAPOSS_RAISE3
    { SPR_BPSS,  7,                                5,               NULL,              S_BETAPOSS_RUN1    }, // S_BETAPOSS_RAISE4

    { SPR_BSPS,  0,                               10,               A_Look,            S_BETASPOS_STND2   }, // S_BETASPOS_STND
    { SPR_BSPS,  1,                               10,               A_Look,            S_BETASPOS_STND    }, // S_BETASPOS_STND2
    { SPR_BSPS,  0,                                3,               A_Chase,           S_BETASPOS_RUN2    }, // S_BETASPOS_RUN1
    { SPR_BSPS,  0,                                3,               A_Chase,           S_BETASPOS_RUN3    }, // S_BETASPOS_RUN2
    { SPR_BSPS,  1,                                3,               A_Chase,           S_BETASPOS_RUN4    }, // S_BETASPOS_RUN3
    { SPR_BSPS,  1,                                3,               A_Chase,           S_BETASPOS_RUN5    }, // S_BETASPOS_RUN4
    { SPR_BSPS,  2,                                3,               A_Chase,           S_BETASPOS_RUN6    }, // S_BETASPOS_RUN5
    { SPR_BSPS,  2,                                3,               A_Chase,           S_BETASPOS_RUN7    }, // S_BETASPOS_RUN6
    { SPR_BSPS,  3,                                3,               A_Chase,           S_BETASPOS_RUN8    }, // S_BETASPOS_RUN7
    { SPR_BSPS,  3,                                3,               A_Chase,           S_BETASPOS_RUN1    }, // S_BETASPOS_RUN8
    { SPR_BSPS,  4,                               10,               A_FaceTarget,      S_BETASPOS_ATK2    }, // S_BETASPOS_ATK1
    { SPR_BSPS,  5 | FF_FULLBRIGHT,               10,               A_SPosAttack,      S_BETASPOS_ATK3    }, // S_BETASPOS_ATK2
    { SPR_BSPS,  4,                               10,               NULL,              S_BETASPOS_RUN1    }, // S_BETASPOS_ATK3
    { SPR_BSPS,  6,                                3,               NULL,              S_BETASPOS_PAIN2   }, // S_BETASPOS_PAIN
    { SPR_BSPS,  6,                                3,               A_Pain,            S_BETASPOS_RUN1    }, // S_BETASPOS_PAIN2
    { SPR_BSPS,  7,                                5,               NULL,              S_BETASPOS_DIE2    }, // S_BETASPOS_DIE1
    { SPR_BSPS,  8,                                5,               A_Scream,          S_BETASPOS_DIE3    }, // S_BETASPOS_DIE2
    { SPR_BSPS,  9,                                5,               A_Fall,            S_BETASPOS_DIE4    }, // S_BETASPOS_DIE3
    { SPR_BSPS, 10,                                5,               NULL,              S_BETASPOS_DIE5    }, // S_BETASPOS_DIE4
    { SPR_BSPS, 11,                               -1,               NULL,              S_NULL             }, // S_BETASPOS_DIE5
    { SPR_BSPS, 11,                                5,               NULL,              S_BETASPOS_RAISE2  }, // S_BETASPOS_RAISE1
    { SPR_BSPS, 10,                                5,               NULL,              S_BETASPOS_RAISE3  }, // S_BETASPOS_RAISE2
    { SPR_BSPS,  9,                                5,               NULL,              S_BETASPOS_RAISE4  }, // S_BETASPOS_RAISE3
    { SPR_BSPS,  8,                                5,               NULL,              S_BETASPOS_RAISE5  }, // S_BETASPOS_RAISE4
    { SPR_BSPS,  7,                                5,               NULL,              S_BETASPOS_RUN1    }, // S_BETASPOS_RAISE5

    { SPR_BCHG,  0,                                1,               A_WeaponReady,     S_BETACHAIN        }, // S_BETACHAIN
    { SPR_BCHG,  0,                                1,               A_Lower,           S_BETACHAINDOWN    }, // S_BETACHAINDOWN
    { SPR_BCHG,  0,                                1,               A_Raise,           S_BETACHAINUP      }, // S_BETACHAINUP
    { SPR_BCHG,  0,                                4,               A_FireCGun,        S_BETACHAIN2       }, // S_BETACHAIN1
    { SPR_BCHG,  1,                                4,               A_FireCGun,        S_BETACHAIN3       }, // S_BETACHAIN2
    { SPR_BCHG,  1,                                0,               A_ReFire,          S_BETACHAIN        }, // S_BETACHAIN3

    { SPR_BCHF,  0 | FF_FULLBRIGHT,                5,               A_Light1,          S_LIGHTDONE        }, // S_BETACHAINFLASH1
    { SPR_BCHF,  1 | FF_FULLBRIGHT,                5,               A_Light2,          S_LIGHTDONE        }, // S_BETACHAINFLASH2

    { SPR_BPLG,  0,                                1,               A_WeaponReady,     S_BETAPLASMA       }, // S_BETAPLASMA
    { SPR_BPLG,  0,                                1,               A_Lower,           S_BETAPLASMADOWN   }, // S_BETAPLASMADOWN
    { SPR_BPLG,  0,                                1,               A_Raise,           S_BETAPLASMAUP     }, // S_BETAPLASMAUP
    { SPR_BPLG,  0,                                3,               A_FirePlasma,      S_BETAPLASMA2      }, // S_BETAPLASMA1
    { SPR_BPLG,  1,                               20,               A_ReFire,          S_BETAPLASMA       }, // S_BETAPLASMA2

    { SPR_BPLF,  0 | FF_FULLBRIGHT,                4,               A_Light1,          S_LIGHTDONE        }, // S_BETAPLASMAFLASH1

    { SPR_BMSL,  1 | FF_FULLBRIGHT,                8,               A_Explode,         S_BETAEXPLODE2     }, // S_BETAEXPLODE1
    { SPR_BMSL,  2 | FF_FULLBRIGHT,                6,               NULL,              S_BETAEXPLODE3     }, // S_BETAEXPLODE2
    { SPR_BMSL,  3 | FF_FULLBRIGHT,                4,               NULL,              S_NULL             }, // S_BETAEXPLODE3

    // killough 7/19/98: First plasma fireball in the beta:
    { SPR_BPL1,  0 | FF_FULLBRIGHT,                6,               NULL,              S_BPL1BALL2        }, // S_BPL1BALL
    { SPR_BPL1,  1 | FF_FULLBRIGHT,                6,               NULL,              S_BPL1BALL         }, // S_BPL1BALL2
    { SPR_BPL1,  2 | FF_FULLBRIGHT,                4,               NULL,              S_BPL1EXP2         }, // S_BPL1EXP
    { SPR_BPL1,  3 | FF_FULLBRIGHT,                4,               NULL,              S_BPL1EXP3         }, // S_BPL1EXP2
    { SPR_BPL1,  4 | FF_FULLBRIGHT,                4,               NULL,              S_BPL1EXP4         }, // S_BPL1EXP3
    { SPR_BPL1,  5 | FF_FULLBRIGHT,                4,               NULL,              S_BPL1EXP5         }, // S_BPL1EXP4
    { SPR_BPL1,  6 | FF_FULLBRIGHT,                4,               NULL,              S_NULL             }, // S_BPL1EXP5

    // killough 7/19/98: Second plasma fireball in the beta:
    { SPR_BPL2,  0 | FF_FULLBRIGHT,                4,               NULL,              S_BPL2BALL2        }, // S_BPL2BALL
    { SPR_BPL2,  1 | FF_FULLBRIGHT,                4,               NULL,              S_BPL2BALL         }, // S_BPL2BALL2
    ...
    { SPR_PLAY, 17,                                5,               NULL,              S_PLAY_GDIE5       }, // S_PLAY_GDIE4
    { SPR_PLAY, 18,                                5,               NULL,              S_PLAY_GDIE6       }, // S_PLAY_GDIE5
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] =
{
    ...
    // Spectre (MT_SHADOWS)
    {
        ...
        /* damage               */ 0,
        /* activesound          */ sfx_dmact,
        /* flags                */ MF_SOLID | MF_SHOOTABLE | MF_SHADOW | MF_COUNTKILL | MF_TRANSLUCENT,
        /* flags2               */ MF2_CRUSHABLE | MF2_NOLIQUIDBOB,
        /* raisestate           */ S_SARG_RAISE1,
        /* frames               */ 0,
        /* blood                */ MT_FUZZYBLOOD,
        /* shadowoffset         */ 2 * FRACUNIT,
    ...
    // Gore (MT_FLESH)
    {
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Flesh and Meat",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Bloody Spray (MT_SPRAY)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_SPRAY_00,
        /* spawnhealth          */ 1000,
    ...
    // Splash Base (MT_WATERSPLASHBASE)
    {
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Water Splash Base",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Lava Splash (MT_LAVASPLASH)
    {
        /* doomednum            */ -1,
    ...
    // Beta Headcandles (MT_BETAHEADCANDLES)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETAHEADCANDLES,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Pile of Skulls and Candles",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Gibs (MT_BETAGIBS)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETAGIBS,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Pool of Blood and Bones",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Blue Skull Key (MT_BETABLUESKULLKEY)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETABSKULL,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Blue Skull Key Card",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Red Skull Key (MT_BETAREDSKULLKEY)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETARSKULL,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Red Skull Key Card",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Yellow Skull Key (MT_BETAYELLOWSKULLKEY)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETAYSKULL,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Yellow Skull Key Card",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Shotgun Shells (MT_BETASHELL)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETASHELL,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Shotgun Shells",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta PLasma Rifle Cells (MT_BETACELL)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETACELL,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Plasma Rifle Cells",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Box of Shotgun Shells (MT_BETASHELLBOX)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETASBOX,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Box of Shotgun Shells",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Barrel (MT_BETABARREL)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BAR1,
        /* spawnhealth          */ 20,
    ...
    // Beta Partial Invisibility (MT_BETAINS)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETAPINS,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* activesound          */ sfx_None,
        /* flags                */ MF_SPECIAL | MF_COUNTITEM,
        /* flags2               */ MF2_SHADOW | MF2_FLOATBOB | MF2_TRANSLUCENT_33,
        /* raisestate           */ S_NULL,
        /* frames               */ 0,
        /* blood                */ 0,
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Partial Invisibility",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Invulnerability (MT_BETAINV)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETAPINV,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Invulnerability",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Baron of Hell (MT_BETABRUISER)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETABOSS_STND,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_BETABOSS_RUN1,
        /* seesound             */ sfx_brssit,
        /* reactiontime         */ 8,
        /* attacksound          */ sfx_None,
        /* painstate            */ S_BETABOSS_PAIN,
        /* painchance           */ 50,
        /* painsound            */ sfx_dmpain,
        /* meleestate           */ S_BETABOSS_ATK1,
        /* missilestate         */ S_BETABOSS_ATK1,
        /* deathstate           */ S_BETABOSS_DIE1,
        /* xdeathstate          */ S_NULL,
        /* deathsound           */ sfx_brsdth,
        /* speed                */ 8,
        /* radius               */ 24 * FRACUNIT,
        ...
        /* activesound          */ sfx_dmact,
        /* flags                */ MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL,
        /* flags2               */ MF2_SHADOW | MF2_NOLIQUIDBOB | MF2_CRUSHABLE,
        /* raisestate           */ S_BETABOSS_RAISE1,
        /* frames               */ 0,
        /* blood                */ MT_GREENBLOOD,
        /* shadowoffset         */ 4 * FRACUNIT,
        /* particlefx           */ 0,
        /* name1                */ "Beta Baron of Hell",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Tall Green Column (MT_BETACOL1)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETATALLGRNCOL,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Tall Green Column",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Tall Techno Pillar (MT_BETAELEC)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETATECHPILLAR,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Tall Techno Pillar",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Skull on a Pole (MT_BETAHEADONASTICK)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETAHEADONASTICK,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Skull on a Pole",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Impaled Human (MT_BETADEADSTICK)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETADEADSTICK,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Impaled Human",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Twitching Impaled Human (MT_BETALIVESTICK)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETALIVESTICK,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Twitching Impaled Human",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Stalagtite (MT_BETASTALAGTITE)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BETASTALAGTITE,
        /* spawnhealth          */ 1000,
        /* gibhealth            */ 0,
        /* seestate             */ S_NULL,
        /* seesound             */ sfx_None,
        ...
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Stalagtite",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Cacodemon (MT_BETAHEAD)
    {
        /* doomednum            */ -1,
        ...
        /* reactiontime         */ 8,
        /* attacksound          */ sfx_None,
        /* painstate            */ S_BETAHEAD_PAIN,
        /* painchance           */ 128,
        /* painsound            */ sfx_dmpain,
        /* meleestate           */ S_NULL,
        /* missilestate         */ S_BETAHEAD_ATK1,
        /* deathstate           */ S_BETAHEAD_DIE1,
        /* xdeathstate          */ S_NULL,
        /* deathsound           */ sfx_cacdth,
        /* speed                */ 8,
        /* radius               */ 31 * FRACUNIT,
        ...
        /* activesound          */ sfx_dmact,
        /* flags                */ MF_SOLID | MF_SHOOTABLE | MF_FLOAT | MF_NOGRAVITY | MF_COUNTKILL,
        /* flags2               */ MF2_SHADOW | MF2_NOLIQUIDBOB | MF2_NOFOOTCLIP | MF2_CRUSHABLE,
        /* raisestate           */ S_BETAHEAD_RAISE1,
        /* frames               */ 0,
        /* blood                */ MT_BLUEBLOOD,
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Cacodemon",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Zombieman (MT_BETAPOSSESSED)
    {
        /* doomednum            */ -1,
        ...
        /* reactiontime         */ 8,
        /* attacksound          */ sfx_pistol,
        /* painstate            */ S_BETAPOSS_PAIN,
        /* painchance           */ 200,
        /* painsound            */ sfx_popain,
        /* meleestate           */ S_NULL,
        /* missilestate         */ S_BETAPOSS_ATK1,
        /* deathstate           */ S_BETAPOSS_DIE1,
        /* xdeathstate          */ S_NULL,
        /* deathsound           */ sfx_podth1,
        /* speed                */ 8,
        /* radius               */ 20 * FRACUNIT,
        ...
        /* flags                */ MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL,
        /* flags2               */ MF2_SHADOW | MF2_NOLIQUIDBOB | MF2_CRUSHABLE,
        /* raisestate           */ S_BETAPOSS_RAISE1,
        /* frames               */ 0,
        /* blood                */ MT_BLOOD,
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Zombieman",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Shotgun Guy (MT_BETASHOTGUY)
    {
        /* doomednum            */ -1,
        ...
        /* reactiontime         */ 8,
        /* attacksound          */ sfx_None,
        /* painstate            */ S_BETASPOS_PAIN,
        /* painchance           */ 170,
        /* painsound            */ sfx_popain,
        /* meleestate           */ S_NULL,
        /* missilestate         */ S_BETASPOS_ATK1,
        /* deathstate           */ S_BETASPOS_DIE1,
        /* xdeathstate          */ S_NULL,
        /* deathsound           */ sfx_podth2,
        /* speed                */ 8,
        /* radius               */ 20 * FRACUNIT,
        ...
        /* flags                */ MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL,
        /* flags2               */ MF2_SHADOW | MF2_NOLIQUIDBOB | MF2_CRUSHABLE,
        /* raisestate           */ S_BETASPOS_RAISE1,
        /* frames               */ 0,
        /* blood                */ MT_BLOOD,
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Shotgun Guy",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Lost Soul (MT_BETASKULL)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BSKUL_STND,
        /* spawnhealth          */ 100,
        /* gibhealth            */ 0,
        /* seestate             */ S_BSKUL_RUN1,
        /* seesound             */ sfx_None,
        /* reactiontime         */ 8,
        /* attacksound          */ sfx_sklatk,
        /* painstate            */ S_BSKUL_PAIN1,
        /* painchance           */ 256,
        /* painsound            */ sfx_dmpain,
        /* meleestate           */ S_NULL,
        /* missilestate         */ S_BSKUL_ATK1,
        /* deathstate           */ S_BSKUL_DIE1,
        /* xdeathstate          */ S_NULL,
        /* deathsound           */ sfx_firxpl,
        /* speed                */ 8,
        /* radius               */ 16 * FRACUNIT,
        ...
        /* flags2               */ MF2_SHADOW | MF2_NOFOOTCLIP | MF2_NOLIQUIDBOB | MF2_TRANSLUCENT_REDONLY,
        /* raisestate           */ S_NULL,
        /* frames               */ 0,
        /* blood                */ 0,
        /* shadowoffset         */ 0,
        /* particlefx           */ 0,
        /* name1                */ "Beta Lost Soul",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ ""
    },

    // Beta Imp Projectile (MT_TROOPSHOT2)
    {
        /* doomednum            */ -1,
        /* spawnstate           */ S_BPL2BALL,
        /* spawnhealth          */ 1000,
    ...
    // Particle (MT_PARTICLE)
    {
        ...
        /* damage               */ 0,
        /* activesound          */ sfx_None,
        /* flags                */ MF_NOGRAVITY | MF_TRANSLUCENT | MF_NOBLOCKMAP,
        /* flags2               */ 0,
        /* raisestate           */ S_NULL,
        /* frames               */ 0,
        /* blood                */ 0,
