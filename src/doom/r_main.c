...
void R_InitColumnFunctions(void)
{
    ...
    if (d_translucency)
    {
        ...
        tl5colfunc = R_DrawTranslucent5Column;
        tl10colfunc = R_DrawTranslucent10Column;
        tl15colfunc = R_DrawTranslucent15Column;
        tl20colfunc = R_DrawTranslucent20Column;
        tl25colfunc = R_DrawTranslucent25Column;
        tl30colfunc = R_DrawTranslucent30Column;
        tl33colfunc = R_DrawTranslucent33Column;
        tl35colfunc = R_DrawTranslucent35Column;
        tl40colfunc = R_DrawTranslucent40Column;
        tl45colfunc = R_DrawTranslucent45Column;
        tl50colfunc = R_DrawTranslucent50Column;
        tl55colfunc = R_DrawTranslucent55Column;
        tl60colfunc = R_DrawTranslucent60Column;
        tl65colfunc = R_DrawTranslucent65Column;
        tl70colfunc = R_DrawTranslucent70Column;
        tl75colfunc = R_DrawTranslucent75Column;
        tl80colfunc = R_DrawTranslucent80Column;
        tl85colfunc = R_DrawTranslucent85Column;
        tl90colfunc = R_DrawTranslucent90Column;
        tl95colfunc = R_DrawTranslucent95Column;
    ...
    else
    {
        ...
        tl5colfunc = R_DrawColumn;
        tl10colfunc = R_DrawColumn;
        tl15colfunc = R_DrawColumn;
        tl20colfunc = R_DrawColumn;
        tl25colfunc = R_DrawColumn;
        tl30colfunc = R_DrawColumn;
        tl33colfunc = R_DrawColumn;
        tl35colfunc = R_DrawColumn;
        tl40colfunc = R_DrawColumn;
        tl45colfunc = R_DrawColumn;
        tl50colfunc = R_DrawColumn;
        tl55colfunc = R_DrawColumn;
        tl60colfunc = R_DrawColumn;
        tl65colfunc = R_DrawColumn;
        tl70colfunc = R_DrawColumn;
        tl75colfunc = R_DrawColumn;
        tl80colfunc = R_DrawColumn;
        tl85colfunc = R_DrawColumn;
        tl90colfunc = R_DrawColumn;
        tl95colfunc = R_DrawColumn;
