...
/*
    ...
    CVAR_INT  (am_allmapcdwallcolor, am_allmapcdwallcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of lines with a change in ceiling height in the automap\nwhen using the computer area map power-up."),
    CVAR_INT  (am_allmapfdwallcolor, am_allmapfdwallcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of lines with a change in floor height in the automap\nwhen using the computer area map power-up."),
    CVAR_INT  (am_allmapwallcolor, am_allmapwallcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of solid walls in the automap when using the computer\narea map power-up."),
    CVAR_INT  (am_backcolor, am_backcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of the background in the automap."),
    CVAR_INT  (am_cdwallcolor, am_cdwallcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of lines with a change in ceiling height in the automap."),
    CVAR_BOOL (am_external, "", bool_cvars_func1, am_external_cvar_func2, "Toggles rendering of the automap on an external display."),
    CVAR_INT  (am_fdwallcolor, am_fdwallcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of lines with a change in floor height in the automap."),
    ...
    CVAR_INT  (am_gridcolor, am_gridcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of the grid in the automap."),
    CVAR_INT  (am_markcolor, am_markcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of marks in the automap."),
    CVAR_INT  (am_playercolor, am_playercolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of the player arrow in the automap."),
    CVAR_BOOL (am_rotatemode, "", bool_cvars_func1, bool_cvars_func2, "Toggles rotate mode in the automap."),
    CVAR_INT  (am_teleportercolor, am_teleportercolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of teleporter lines in the automap."),
    CVAR_INT  (am_thingcolor, am_thingcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of thing triangles in the automap."),
    CVAR_INT  (am_tswallcolor, am_tswallcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of lines with no change in height in the automap."),
    CVAR_INT  (am_wallcolor, am_wallcolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of solid walls in the automap."),
    CVAR_INT  (am_xhaircolor, am_xhaircolour, int_cvars_func1, color_cvars_func2, CF_NONE, 0, "The color of the crosshair in the automap."),
...
//    CVAR_INT  (episode, "", int_cvars_func1, int_cvars_func2, CF_NONE, 0, "The currently selected ~DOOM~ episode in the menu."),
    CMD       (exitmap, "", game_func1, exitmap_cmd_func2, 0, "", "Exits the current map."),
/*
    CVAR_INT  (expansion, "", int_cvars_func1, int_cvars_func2, CF_NONE, 0, "The currently selected ~DOOM II~ expansion in the menu."),
    CVAR_INT  (facebackcolor, facebackcolour, int_cvars_func1, int_cvars_func2, CF_NONE, 0, "The color behind the player's face in the status bar."),
...
/*
    ...
    CVAR_INT  (gp_sensitivity, "", int_cvars_func1, gp_sensitivity_cvar_func2, CF_NONE, 0, "The gamepad's sensitivity."),
...
/*
    ...
    CVAR_INT  (m_sensitivity, "", int_cvars_func1, int_cvars_func2, CF_NONE, 0, "The mouse's sensitivity."),
    CVAR_INT  (m_threshold, "", int_cvars_func1, int_cvars_func2, CF_NONE, 0, "The mouse's acceleration threshold."),
*/
...
/*
    ...
    CVAR_INT  (movebob, "", int_cvars_func1, int_cvars_func2, CF_PERCENT, 0, "The amount the player bobs when moving."),
*/
...
/*
    ...
    CVAR_INT  (r_berserkintensity, "", int_cvars_func1, int_cvars_func2, CF_PERCENT, 0, "The intensity of the screen's red haze when the player has the\nberserk power-up and their fists selected."),
    CVAR_INT  (r_blood, "", r_blood_cvar_func1, r_blood_cvar_func2, CF_NONE, 4, "The color of the blood of the player and monsters (all, none or\nred)."),
    CVAR_INT  (r_bloodsplats_max, "", int_cvars_func1, int_cvars_func2, CF_NONE, 0, "The maximum number of blood splats allowed in a map (0 to\n1,048,576)."),
    CVAR_INT  (r_bloodsplats_total, "", int_cvars_func1, int_cvars_func2, CF_READONLY, 0, "The total number of blood splats in the current map."),
    ...
    CVAR_BOOL (r_fixmaperrors, "", bool_cvars_func1, bool_cvars_func2, "Toggles the fixing of mapping errors in the ~DOOM~ and ~DOOM II~\nIWADs."),
    ...
    CVAR_INT  (r_screensize, "", int_cvars_func1, r_screensize_cvar_func2, CF_NONE, 0, "The screen size."),
...
/*
    CVAR_INT  (s_musicvolume, "", s_volume_cvars_func1, s_volume_cvars_func2, CF_PERCENT,  0, "The music volume."),
    ...
    CVAR_INT  (s_sfxvolume, "", s_volume_cvars_func1, s_volume_cvars_func2, CF_PERCENT, 0, "The sound effects volume."),
    ...
    CVAR_INT  (skilllevel, "", int_cvars_func1, int_cvars_func2, CF_NONE, 0, "The currently selected skill level in the menu."),
*/
    CMD       (spawn, summon, spawn_cmd_func1, spawn_cmd_func2, 1, SPAWNCMDFORMAT, "Spawns a monster or item."),
//    CVAR_INT  (stillbob, "", int_cvars_func1, int_cvars_func2, CF_PERCENT, 0, "The amount the player bobs when still."),
    CMD       (thinglist, "", game_func1, thinglist_cmd_func2, 0, "", "Shows a list of things in the current map."),
//    CVAR_INT  (turbo, "", turbo_cvar_func1, turbo_cvar_func2, CF_PERCENT,  0, "The speed of the player (10% to 400%)."),
...
/*
    ...
    CVAR_INT  (vid_display, "", int_cvars_func1, vid_display_cvar_func2, CF_NONE, 0, "The display used to render the game."),
...
static void god_cmd_func2(char *cmd, char *parm1, char *parm2, char *parm3)
{
    ...
    if (*parm1)
    {
        int     value = /*C_LookupValueFromAlias(parm1, 1)*/0;
...
//        episode = mapcmdepisode - 1;
    ...
    else if (fsize == 28422764 && sscanf(parm1, "C%1iM%1i", &mapcmdepisode, &mapcmdmap) == 2)
    {
        static char     lump[5];
...
static void maplist_cmd_func2(char *cmd, char *parm1, char *parm2, char *parm3)
{
    ...
    for (i = 0; i < numlumps; ++i)
    {
        ...
        replaced = (W_CheckMultipleLumps(lump) > 1 && fsize != 12361532 && fsize != 28422764);
        ...
        switch (gamemission)
        {
            ...
            case doom2:
                if (!M_StringCompare(wad, "nerve.wad") && (!replaced || pwad || nerve_pwad)
                    && (pwad || !BTSX))
                {
                    if (BTSX)
                    {
                        ...
                        M_snprintf(maplist[count++], 256, "%s\t%s\t%s", lump, (replaced
                            && dehcount == 1 && !nerve_pwad && !*mapinfoname ? "-" :
                            titlecase(*mapinfoname ? mapinfoname : (bfgedition ?
                            *mapnames2_bfg[map] : *mapnames2[map]))), (modifiedgame && !nerve_pwad ?
                            wad : ""));
                }
                break;
...
{
    return (!*parm1 || C_LookupValueFromAlias(parm1, 1) >= 0);
}
    ...
    while (*consolecmds[i].name)
    {
            ...
            && (consolecmds[i].flags & CF_BOOLEAN))
        {
            if (*parm1 && !(consolecmds[i].flags & CF_READONLY))
            {
                ...
                C_Output(C_LookupAliasFromValue(*(dboolean *)consolecmds[i].variable, 1));
        }
        ++i;
    }
}
...
{
    return (!*parm1 || C_LookupValueFromAlias(parm1, 4) >= 0);
}
*/
...
static void r_blood_cvar_func2(char *cmd, char *parm1, char *parm2, char *parm3)
{
    if (*parm1)
    {
        ...
        C_Output(C_LookupAliasFromValue(r_blood, 4));
}
...
{
    return (!*parm1 || C_LookupValueFromAlias(parm1, 2) >= 0);
}
...
static void r_detail_cvar_func2(char *cmd, char *parm1, char *parm2, char *parm3)
{
    if (*parm1)
    {
        ...
        C_Output(C_LookupAliasFromValue(r_detail, 2));
}
*/
...
{
    if (/*vid_widescreen ||*/ r_screensize == 8)
        bool_cvars_func2(cmd, parm1, "", "");
}
...
static dboolean s_volume_cvars_func1(char *cmd, char *parm1, char *parm2, char *parm3)
{
    ...
    return ((M_StringCompare(cmd, stringize(s_musicvolume)) && value >= 1
        && value <= 15) || (M_StringCompare(cmd, stringize(s_sfxvolume))
        && value >= 1 && value <= 15));
}
...
static void s_volume_cvars_func2(char *cmd, char *parm1, char *parm2, char *parm3)
{
    if (*parm1)
    {
        ...
        {
            s_musicvolume = value;
            musicVolume = (BETWEEN(1, s_musicvolume,
                15) * 15 + 50) / 100;
        ...
        {
            s_sfxvolume = value;
            sfxVolume = (BETWEEN(1, s_sfxvolume, 15) * 15 + 50) / 100;
...
static void vid_fullscreen_cvar_func2(char *cmd, char *parm1, char *parm2, char *parm3)
{
    if (*parm1)
    {
        ...
        C_Output(C_LookupAliasFromValue(vid_fullscreen, 1));
}
...
static void vid_showfps_cvar_func2(char *cmd, char *parm1, char *parm2, char *parm3)
{
    if (*parm1)
    {
        ...
        C_Output(C_LookupAliasFromValue(vid_showfps, 1));
}
...
static void vid_vsync_cvar_func2(char *cmd, char *parm1, char *parm2, char *parm3)
{
    if (*parm1)
    {
        ...
        C_Output(C_LookupAliasFromValue(vid_vsync, 1));
}
...
static void vid_widescreen_cvar_func2(char *cmd, char *parm1, char *parm2, char *parm3)
{
    if (*parm1)
    {
        ...
        C_Output(C_LookupAliasFromValue(vid_widescreen, 1));
}
