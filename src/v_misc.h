...
void V_WriteTextXYGapFontColoured(const char *s, int colour, int x, int y, int xgap, int ygap, patch_t *font);
/*
...
*/
int V_StringWidthGapFont(const char *s, int gap, patch_t *font);
